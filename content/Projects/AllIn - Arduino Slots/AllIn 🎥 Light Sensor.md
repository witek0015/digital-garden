...
Light sensor has a lot of things going on - simple ones like VCC and GND can be paralleles, but idk about the rest of these cables - for sue OUT cannot be, since it spews data
code: 
```arduino
